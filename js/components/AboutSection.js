            ...
            <section id="about" class="active" aria-hidden="false" aria-labelledby="about-heading">
                ...
                <div class="about-container">
                    ...
                    <div class="about-details">
                        <p>Hi, I am <span class="highlight">Anecito Randy E. Calunod Jr</span>, a 22-year-old Information Technology student based in Ozamiz City, Misamis Occidental.</p>
                        ...
                        <p class="tech-font" style="margin-top:20px; color: var(--neon-cyan);">> "Nothing is impossible."</p>
                    </div>
                </div>
            </section>
        `;
