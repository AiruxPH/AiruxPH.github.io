            ...
            <section id="certifications" aria-hidden="true" aria-labelledby="certifications-heading">
                ...
                <div class="projects-grid">
                     <div class="project-card glass-panel" style="align-items: center; text-align: center;">
                        ...
                        <h3><a href="https://www.credly.com/badges/c384d9a2-979a-4215-925a-997620c05ac4" target="_blank" style="color: white; text-decoration: none;">CCNA: Introduction to Networks <i class="fa-solid fa-external-link-alt" style="font-size: 0.8em; margin-left: 5px; color: var(--neon-cyan);"></i></a></h3>
